...
: min_pnp_pairs_(4),
  ...
  lidartag_convergence_rotation_(),
  lidartag_convergence_rotation_dot_(0.0001),
  lidartag_new_hypothesis_translation_(0.2),
  lidartag_new_hypothesis_rotation_(CV_PI * 45 / 180.0),
  lidartag_process_noise_translation_(0.005),
  lidartag_process_noise_translation_dot_(0.005),
  lidartag_process_noise_rotation_(CV_PI * 0.5 / 180.0),
  lidartag_process_noise_rotation_dot_(CV_PI * 0.5 / 180.0),
  lidartag_measurement_noise_translation_(0.05),
  lidartag_measurement_noise_rotation_(CV_PI * 5 / 180.0),
  ...
  const lidartag_msgs::msg::LidarTagDetection & detection, const rclcpp::Time & stamp)
{
  ...
  new_h->setMaxConvergenceThreshold(
    ...
    lidartag_convergence_rotation_, lidartag_convergence_rotation_dot_);
  new_h->setMeasurementNoise(
    lidartag_measurement_noise_translation_, lidartag_measurement_noise_rotation_);
  new_h->setNewHypothesisThreshold(
    lidartag_new_hypothesis_translation_, lidartag_new_hypothesis_rotation_);
  new_h->setProcessNoise(
    lidartag_process_noise_translation_, lidartag_process_noise_translation_dot_,
    lidartag_process_noise_rotation_, lidartag_process_noise_rotation_dot_);
...
void CalibrationEstimator::setLidartagMaxConvergenceThreshold(
  double translation, double transl_dot, double rotation, double rotation_dot)
{
  lidartag_convergence_translation_ = translation;
  lidartag_convergence_translation_dot_ = transl_dot;
  lidartag_convergence_rotation_ = CV_PI * rotation / 180.0;
  lidartag_convergence_rotation_dot_ = CV_PI * rotation_dot / 180.0;
}

void CalibrationEstimator::setLidartagNewHypothesisThreshold(
  double max_translation, double max_rotation)
{
  lidartag_new_hypothesis_translation_ = max_translation;
  lidartag_new_hypothesis_rotation_ = CV_PI * max_rotation / 180.0;
}

void CalibrationEstimator::setLidartagMeasurementNoise(double translation, double rotation)
{
  lidartag_measurement_noise_translation_ = translation;
  lidartag_measurement_noise_rotation_ = CV_PI * rotation / 180.0;
}
  ...
  double translation, double translation_dot, double rotation, double rotation_dot)
{
  ...
  lidartag_process_noise_rotation_ = CV_PI * rotation / 180.0;
  lidartag_process_noise_rotation_dot_ = CV_PI * rotation_dot / 180.0;
}
...
void CalibrationEstimator::setApriltagNewHypothesisThreshold(double max_translation)
{
  apriltag_new_hypothesis_translation_ = max_translation;
}
